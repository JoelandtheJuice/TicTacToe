...
public class TicTacToeController {
    ...
    public boolean isMoveLegal(int move) {
        ...
        else if (gameRepo.board[move / gameRepo.BOARD_SIZE][move % gameRepo.BOARD_SIZE] == 'X' 
                || gameRepo.board[move / gameRepo.BOARD_SIZE][move % gameRepo.BOARD_SIZE] == 'O') {
    ...
    public void makeMove(int move) {
        gameRepo.board[move/3][move%3] = getCurrentPlayerChar();
        updatePlayer();
    }
